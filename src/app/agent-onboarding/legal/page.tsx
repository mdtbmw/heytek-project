...
export default function LegalPage() {
  ...
  useEffect(() => {
    const founderPath = role === 'founder_ceo';
    setCurrentStep(founderPath ? 5 : 6); // Step 5 for founder, 6 for others
  ...
  }, [setCurrentStep, onboardingData.profile?.country, role, countryName]);
